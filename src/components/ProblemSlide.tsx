        ...
        <div className="text-center">
          ...
          >
            <div className="flex items-baseline justify-center">
              <motion.span 
                className="text-8xl md:text-9xl font-bold text-[#D3FFF4] mr-4"
                initial={{ opacity: 0 }}
                animate={isInView ? { opacity: 1 } : { opacity: 0 }}
          ...
          <div className="flex flex-col items-center space-y-8">
            <motion.p
              className="text-xl md:text-2xl leading-relaxed text-white max-w-4xl"
            ...
            >
              <div className="text-center">
                <motion.span 
                  className="block text-6xl md:text-7xl font-bold text-[#D3FFF4] mb-2"
                  initial={{ scale: 0.5 }}
                ...
                <span className="text-lg md:text-xl text-white">receiving care</span>
              </div>
              ...
              <div className="text-center">
                ...
                <span className="text-lg md:text-xl text-white">years delay in diagnosis</span>
              </div>
            </motion.div>
          </div>
        </div>
